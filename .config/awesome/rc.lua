...
kbdcfg.add_primary_layout("English", "ENG", "us")
kbdcfg.add_primary_layout("Русский", "RUS", "ru")
...
globalkeys = gears.table.join(
	...
	awful.key({ "Shift" }, "Alt_L", function()
		kbdcfg.switch_next()
	end, { description = "switch keyboard", group = "custom" }),
	awful.key({ modkey }, "space", function()
		kbdcfg.switch_next()
	end, { description = "switch keyboard", group = "custom" }),
	...
	end, { description = "start rofi launcher", group = "launcher" }),
	awful.key({ modkey, "Shift" }, "r", function()
		awful.spawn.with_shell("rofi -show run")
	end, { description = "start rofi run", group = "launcher" }),
